                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="colorCode"><g:message code="color.colorCode.label" default="Color Code" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: colorInstance, field: 'colorCode', 'errors')}">
                                    <g:textField name="colorCode" maxlength="7" value="${colorInstance?.colorCode}" />
                                </td>
                            </tr>
