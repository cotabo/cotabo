            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="color.colorCode.label" default="Color Code" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: colorInstance, field: "colorCode")}</td>
