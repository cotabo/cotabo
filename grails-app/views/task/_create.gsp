     ...
     <div>
     	<table>
     		<tbody>
     			<tr>
     				<td>
     					<label for="name" alt="A short task name">Task name</label>
     				</td>
     				<td>
     			...
     			<tr>
     				<td>
     					<label for="description" alt="A description of the Task" class="optional"></label>
     				</td>
     				<td>
     			...
     			<tr>
     				<td>
     					<label for="duration" alt="The duration of the task (in hours)" class="optional"></label>
     				</td>
     				<td>
