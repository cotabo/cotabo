<html>
    ...
    <body>
        <div>
            ...
            <p style="font-style:italic;">version: <g:meta name="app.version"/></p>
            <br/>
            <div id="main_text">
	            <p>
	            ...
	            <p>
		            You can create multiple boards for multiple projects or workstreams.
		        </p>
		        <p>
		            Visualizing your work is one of the most basic things to improve your efficiency.
		            How can you manage something that is now visible?
		        </p>
            ...
            <br/>
            <p>The project is hosted on <a class="highlighted_link" href="https://github.com/cotabo/cotabo" target="_blank">GitHub</a>.<p>
            <p>Please submit any Issues & Feature requests as an issue on GitHub</p>
        </div>
    </body>
</html>
